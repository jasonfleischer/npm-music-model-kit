	...
	constructor(type) {
		...
		switch(type){
			...
			case Note.Name.TYPE.C_sharp:
				...
				this.sharp_name = "C#";
				this.flat_name = "Db";
				this.file_name = ["audio/notes/D_flat.mp3", "audio/notes/or.mp3", "audio/notes/C_sharp.mp3"];
				this.color = "#ff8000";
			...
			case Note.Name.TYPE.D_sharp:
				...
				this.sharp_name = "D#";
				this.flat_name = "Eb";
				this.file_name = ["audio/notes/E_flat.mp3", "audio/notes/or.mp3", "audio/notes/D_sharp.mp3"];
				this.color = "#7fff00";
			...
			case Note.Name.TYPE.F_sharp:
				...
				this.sharp_name = "F#";
				this.flat_name = "Gb";
				this.file_name = ["audio/notes/G_flat.mp3", "audio/notes/or.mp3", "audio/notes/F_sharp.mp3"];
				this.color = "#00ffff";
			...
			case Note.Name.TYPE.G_sharp:
				...
				this.sharp_name = "G#";
				this.flat_name = "Ab";
				this.file_name = ["audio/notes/A_flat.mp3", "audio/notes/or.mp3", "audio/notes/G_sharp.mp3"];
				this.color = "#0000ff";
			...
			case Note.Name.TYPE.A_sharp:
				...
				this.sharp_name = "A#";
				this.flat_name = "Bb";
				this.file_name = ["audio/notes/B_flat.mp3", "audio/notes/or.mp3", "audio/notes/A_sharp.mp3"];
				this.color = "#ff00ff";
